...
const MenuSubFeatures =(props)=>{
  ...
  // const [opneClose, setOpenClose] = useState("./img/open.png");
    ...
    return(
        ...
        <AccordionDetails tabIndex="1" id="angleOneBtn" onKeyPress={props.angleOneClicked}  onClick={props.openClosedClicked}>
        <MenuCircleBtnOpenClose changeOpenCloseImg={props.tobechange}  className="openclose" submenu="angle 1 " />
        </AccordionDetails>  
        <AccordionDetails tabIndex="1" id="openCloseBtn" onKeyPress={props.angleTwoClicked}  onClick={props.angleTwoClicked}>
        <MenuCircleBtnOpenClose changeOpenCloseImg={props.tobechange}  className="openclose" submenu="angle 2 " />
        </AccordionDetails>
        <AccordionDetails tabIndex="1"  id="backlitBtn" onKeyPress={props.angleThreeClicked} onClick={props.angleThreeClicked}>
        <MenuCircleBtnBacklite changeBacklitImg={props.tobeChanged} submenu="angle 3" />
...
export default MenuSubFeatures;